...
```
Импортируем библиотеки Tesseract и PIL:
![ether](00.PNG) 
Загружаем изображение и распознаем текст на нём:
![ether](0.PNG) 
## Работа с представлением уравнений в виде матриц и решение системы уравнений

Для старта импортируем установленные ранее scipy и numpy. Распознанный текст сохраним в массив, где каждый элемент массива будет содержать одно уравнение системы. Для решения задачи необходимо получить две матрицы: одна для хранения коэффициентов перед неизвестными, вторая для хранения результатов уравнений.
